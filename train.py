...
def model_init(
	...
	model = model_type(in_channels=in_channels, num_classes=num_classes, imgsz=imgsz).to(device).to(memory_format=torch.channels_last)
	load_model(model)
...
if __name__ == "__main__":
	...
	# Initialising Model
	model, loss_fn, optimizer, scheduler = model_init(MODEL, in_channels=in_channels, num_classes=num_classes, imgsz=imgsz)
